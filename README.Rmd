...
![](inst/images/stocks_DEU.png){width=500}
```r
gdiplot(code = "popmap", country = "DEU")
```

![](inst/images/popmap_DEU.png){width=90%}

```r
gdiplot(code = "idp", country = "DEU")
```

![](inst/images/idp_DEU.png){fig-align="center" width=90%}
...
![](inst/images/irischart.png){width=90%}
